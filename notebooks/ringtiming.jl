...
# ╔═╡ f5fe4430-a976-11ed-1da1-97b53b7b8021
begin
	using PyThermo, PyThermo.ShockTube, Unitful
	using CairoMakie
	using Roots
end

# ╔═╡ f1ab7d06-3901-4c7d-98e6-2f41c4181029
viscosity(species) = species.mu * u"Pa*s"

# ╔═╡ e2206fc3-1c2d-4723-82ed-6e545ed5c3eb
N2 = Species("N2", T=19u"°C", P=14.5u"psi")

# ╔═╡ e80e2e64-ae6d-4bd5-b493-6d4f87df44b1
ace = Species("acetone", T=19u"°C")

# ╔═╡ fb243ff9-6173-48ee-97ae-671b2130a843
gas = "N2"

# ╔═╡ 150e9c27-b698-43e9-9210-32d9cf2600bb
P_reservoir = 35u"psi" |> u"Pa"

# ╔═╡ f55d08c6-f67a-4977-8147-33a83a8fad63
χAce = ace.Psat*u"Pa"  / P_reservoir

# ╔═╡ 158634ce-9ad2-4d9f-ae66-02ecb3f091d0
MST_driver = Mixture([gas => 1 - χAce, "acetone" => χAce], T=22u"°C", P=P_reservoir)

# ╔═╡ 8c8b6af7-c899-49fd-956d-21c70e9ab278
MST_driven = Mixture([gas => 1 - χAce, "acetone" => χAce], T=22u"°C", P=14.5u"psi")

# ╔═╡ 5c239f1b-9abc-4b63-a984-6aa40d341e0f
Ma = fzero(M -> pressure(shockcalc(MST_driver, MST_driven, M).driver) - P_reservoir, 			1.1)

# ╔═╡ bf7da07b-4ff3-4ba7-a403-c6203b389a53
sc = shockcalc(MST_driver, MST_driven, Ma)

# ╔═╡ 64759c5a-302d-4312-96fa-cf36dbbe54a6
begin
	L = 10.5u"inch" |> u"cm"
	h1 = 17u"cm"
	h2 = 25.8u"cm"
...
# ╔═╡ e4716bf8-c632-4fe4-8fe5-45508b49c15e
t_MST = L / soundspeed(sc.driven)*sc.Ms + δt |> u"s"

# ╔═╡ 45d1e836-fc7d-4351-92a7-f8263024995b
 ϕ = 0.75

# ╔═╡ 05cd5a04-661a-4795-afe9-61b6e05550d6
t1 = t_MST + h1/(ϕ*sc.u2) |> u"μs"

# ╔═╡ 8fecdd18-4ea4-4f89-bc98-9e9f0c5b526f
t2 = t_MST + h2/(ϕ*sc.u2) |> u"μs"

# ╔═╡ 9f31ceb8-7cd5-4016-aedf-485b3df1443c
t3 = t_MST + h3/(ϕ*sc.u2) |> u"μs"

# ╔═╡ 2d1fa46a-7333-4cc4-ae9c-7b4906c1233a
Re = MST_driven.Reynolds(ustrip(u"m/s", 0.83*sc.u2), ustrip(u"m", 0.875u"inch"))
...
manifest_format = "2.0"
project_hash = "945191c55fefeac68f97f46422190fbd88e98ee9"
...
[[deps.PyThermo]]
deps = ["CondaPkg", "Markdown", "Pkg", "Printf", "PythonCall", "Unitful"]
git-tree-sha1 = "8af7426978ef95d5a21213467e7d496073e3312c"
